const CACHE_NAME = 'leadership-hub-shell-v3';
const STATIC_SHELL = [
...
self.addEventListener('fetch', (event) => {
  ...
  const excludedPrefixes = ['/author-admin.html', '/preview.html', '/api/', '/.netlify/functions/', '/audio_summaries/', '/uploads/', '/account', '/login', '/logout', '/membership', '/checkout', '/billing', '/subscribe'];
