...
export default async (request) => {
  ...
  const prompt = `Create a new editorial illustration for a Traditional Chinese leadership learning website. Subject: ${title}. Category: ${category}. Match the established article-15-to-17 visual language: hand-painted watercolor and gouache editorial illustration, warm textured ivory paper, muted olive and deep forest green, ochre gold and restrained terracotta accents, natural expressive people in a real workplace conversation or collaborative learning scene, thoughtful human-centered leadership atmosphere, visible paper grain and soft brush edges, balanced wide landscape composition with layered depth, premium quiet magazine style. Keep visual continuity with the existing article illustrations, but create a new scene specifically for this article. No text, no letters, no numbers, no logos, no watermark, no gradients, no glossy 3D, no photorealism, no generic corporate stock-photo look.`;
  try {
